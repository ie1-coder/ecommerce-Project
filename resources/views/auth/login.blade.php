{{--
    ...
    PURPOSE: Professional login page with modern design
...
@section('title', 'Sign In | Professional Store')
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <button type="button"
                            class="w-full inline-flex justify-center py-2.5 px-4 border border-slate-300 rounded-xl bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
